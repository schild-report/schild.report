...
<div class="box">
  <p class="subtitle is-4 has-text-grey">schild.report</p><br>
    <div class="field">
      <p class="control">
    ...
    <button class="button is-block is-link is-large is-fullwidth"
            class:is-danger={fehler}
            on:click={authorize}>{fehler ? 'Benutzerdaten falsch' : 'Anmelden'}</button><br>
</div>