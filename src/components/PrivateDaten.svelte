...
<div class="box">
  <p class="subtitle is-4 has-text-grey has-text-centered">Eigene Datenfelder</p><br>
  Die Key/Value-Paare können anschließend in den Reports eingesetzt werden.
  Legen Sie z.B. fest, wo der Report das Logo für ihre Schule findet. Diese
  Werte können anschließend im Report unter <code>{`{privat.IhrKey}`}</code> abgerufen
  werden.
  <table class="table is-fullwidth ist-striped">
    <thead>
      <tr>
        <td>
            <input class="input"
